			...
			<div class="col-md-12">
				...
				<div class="portlet box blue">
					...
					<form class="form-group"
						action="<c:url value="/admin/video/insert"/>" method="post"
						enctype="multipart/form-data">
						<label class="form-label"
							for="lname">Link Video:</label><br> <input
							class="form-input" type="text" id="lname" name="videoid">
						...
						<div class="div-radio">
							<input class="form-radio" type="radio" id="ston" name="active"
								value="1"><label class="form-label" for="ston">On
							</label><br> <input class="form-input" type="radio" id="stoff"
								name="active" value="0"> <label class="form-label"
								for="stoff">Off</label>
						</div>
						...
						<input class="form-input" type="text" id="fname"
							...
							class="form-input" type="text" id="lname" name="poster">
