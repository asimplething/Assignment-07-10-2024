		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="portlet box blue">
					...
					<form class="form-group" action="<c:url value="/admin/category/update"/>"
						...
						<input class="form-input" type="text" id="fname"
							name="categoryname" value="${cate.categoryname}"><br> <label class="form-label"
							for="lname">Link Images:</label><br> <input
							class="form-input" type="text" id="lname" name="images" value="${cate.images}">
						...
						<label class="form-label" for="lname">Status: </label>
							...
							class="form-radio" type="radio" id="ston" name="status" value="1" ${cate.status==1?'checked':''}><label class="form-label" for="ston">Active </label><br> <input
							class="form-input" type="radio" id="stoff" name="status"
							value="0" ${cate.status!=1?'checked':''}> <label class="form-label" for="stoff">Lock
						</label></div>
